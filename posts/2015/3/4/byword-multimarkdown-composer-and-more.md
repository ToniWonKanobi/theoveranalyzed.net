...
<figure>
	<img class="screenshot" src="http://d.pr/i/fWNQ+" alt="Ehh">
...
<figure>
	<img class="screenshot" src="http://d.pr/i/nOPD+" alt="Easy">
...
<figure>
	<img class="screenshot" src="http://d.pr/i/1azBA+" alt="So much easier">
