...
[^op]: We all know *[that](https://www.youtube.com/watch?v=JXF85txIlIY)* guy. The one who is super stoked to tell you something, and his excitement is almost strange.
[^t]: I have developed quite a knack for identifying people like this within seconds. That, and I assume the person I am talking to knows nothing, just like [Jon Snow](https://www.youtube.com/watch?v=fKgCgnLl8k8#t=23), until proven otherwise.
[^p]: ["Where I spent most of my days / Chillin' out maxin' relaxin' all cool / And all shootin some b-ball outside of school"](http://www.youtube.com/watch?v=AVbQo3IOC_A)
...
[^sub]: Lots of interesting [criticisms of capitalism out there](https://en.wikipedia.org/wiki/Capitalism#Criticism), obviously. But "it is what it is" really seems to apply here. 
...
[^tdl]: Should I buy this? [The domain is totally available](http://www.dnsrsearch.com/index.php?origURL=http%3A//www.thedogelor.com/&r=).
[^att]: Yeah, [that could really happen](http://www.usatoday.com/story/tech/2014/05/08/comcast-time-warner-cable-house-hearing/8847183/)
[^cba]: Yeah, [that really happened](http://www.cnet.com/news/comcast-apologizes-after-re-naming-customer-with-expletive/). 
[^vv]: Apple is likely the worst example for me to use here, because it probably would continue to make excellent things, even if Samsung wasn't copying everything they did and thereby forcing Apple to re-invent itself [quicker than it would like](http://www.marco.org/2015/01/04/apple-lost-functional-high-ground) just to remain fresh
