...
@@ Tags=jailbreak, tech tips, iPhone  

I jailbreak my iOS devices for a myriad of reasons. One big reason is so that I can use [f.lux](https://justgetflux.com/).[^1] But if you are not into that, here is a nifty how-to using Accessibility features built into iOS to dim the screen beyond the lowest level.

Thanks [Scott Forstall](https://en.wikipedia.org/wiki/Scott_Forstall).[^2]
